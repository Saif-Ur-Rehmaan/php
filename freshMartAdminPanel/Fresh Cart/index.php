...
<div class="modal fade" id="userModal" tabindex="-1" aria-labelledby="userModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    ...
    if (isset($_SESSION['UserName'])) {
      ...
      <h4>you loggedin with <?php $_SESSION['User Email']?></h4>
    ...
    <section class="mb-lg-10 mt-lg-14 my-8">
      <div class="container">
        ...
        <div class="category-slider ">
          ...
          <div class="item"> <a href="pages/shop-grid.php" class="text-decoration-none text-inherit">
          ...
          <div class="col">
            <div class="card card-product">
              <div class="card-body">
                ...
                <h2 class="fs-6"><a href="pages/shop-single.php" class="text-inherit text-decoration-none">Haldiram's
                    Sev Bhujia</a></h2>
                <div>
            ...
            <div class="card card-product">
              <div class="card-body">
                <div class="text-center position-relative">
                  ...
                  <a href="pages/shop-single.php"><img src="assets/images/products/product-img-2.jpg"
          ...
          <div class="col">
            <div class="card card-product">
              <div class="card-body">
                ...
                <div class="text-small mb-1"><a href="#!" class="text-decoration-none text-muted"><small>Bakery &
                      Biscuits</small></a></div>
                <h2 class="fs-6"><a href="pages/shop-single.php" class="text-inherit text-decoration-none">Cadbury 5
                    Star Chocolate</a></h2>
                <div class="text-warning">
          ...
          <div class="col">
            <div class="card card-product">
              <div class="card-body">
                ...
                <div class="text-small mb-1"><a href="#!" class="text-decoration-none text-muted"><small>Snack &
                      Munchies</small></a></div>
                <h2 class="fs-6"><a href="pages/shop-single.php" class="text-inherit text-decoration-none">Onion
                    Flavour Potato</a></h2>
                <div class="text-warning">
            ...
            <div class="card card-product">
              <div class="card-body">
                ...
                <div class="text-small mb-1"><a href="#!" class="text-decoration-none text-muted"><small>Instant
                      Food</small></a></div>
                <h2 class="fs-6"><a href="pages/shop-single.php" class="text-inherit text-decoration-none">Salted
            ...
            <div class="card card-product">
              <div class="card-body">
                ...
                <div class="text-small mb-1"><a href="#!" class="text-decoration-none text-muted"><small>Dairy, Bread &
                      Eggs</small></a></div>
                <h2 class="fs-6"><a href="pages/shop-single.php" class="text-inherit text-decoration-none">Blueberry
                    Greek Yogurt</a></h2>
                <div>
          ...
          <div class="col">
            <div class="card card-product">
              <div class="card-body">
                ...
                <div class="text-small mb-1"><a href="#!" class="text-decoration-none text-muted"><small>Dairy, Bread &
                      Eggs</small></a></div>
                <h2 class="fs-6"><a href="pages/shop-single.php" class="text-inherit text-decoration-none">Britannia
                    Cheese Slices</a></h2>
                <div class="text-warning">
          ...
          <div class="col">
            <div class="card card-product">
              <div class="card-body">
                ...
                <div class="text-small mb-1"><a href="#!" class="text-decoration-none text-muted"><small>Instant
                      Food</small></a></div>
                <h2 class="fs-6"><a href="pages/shop-single.php" class="text-inherit text-decoration-none">Kellogg's
                    Original Cereals</a>
                </h2>
                <div class="text-warning">
          ...
          <div class="col">
            <div class="card card-product">
              <div class="card-body">
                ...
                <div class="text-small mb-1"><a href="#!" class="text-decoration-none text-muted"><small>Snack &
                      Munchies</small></a></div>
                <h2 class="fs-6"><a href="pages/shop-single.php" class="text-inherit text-decoration-none">Slurrp
          ...
          <div class="col">
            <div class="card card-product">
              <div class="card-body">
                ...
                <div class="text-small mb-1"><a href="#!" class="text-decoration-none text-muted"><small>Dairy, Bread &
                      Eggs</small></a></div>
                <h2 class="fs-6"><a href="pages/shop-single.php" class="text-inherit text-decoration-none">Amul
                    Butter - 500 g</a></h2>
                <div class="text-warning">
            ...
            <div class="card card-product">
              <div class="card-body">
                ...
                <div class="text-small mb-1"><a href="#!" class="text-decoration-none text-muted"><small>Tea, Coffee &
                      Drinks</small></a></div>
                <h2 class="fs-6"><a href="pages/shop-single.php" class="text-inherit text-decoration-none">Roast
                    Ground Coffee</a></h2>
          ...
          <div class="col">
            <div class="card card-product">
              <div class="card-body">
                ...
                <h2 class="fs-6"><a href="pages/shop-single.php" class="text-inherit text-decoration-none">Crushed
                    Tomatoes</a></h2>
                <div class="d-flex justify-content-between align-items-center mt-3">
                  <div><span class="text-dark">$13</span> <span
                      class="text-decoration-line-through text-muted">$18</span>
          ...
          <div class="col">
            <div class="card card-product">
              <div class="card-body">
                ...
                <div class="text-small mb-1"><a href="#!" class="text-decoration-none text-muted"><small>Fruits &
                      Vegetables</small></a></div>
                <h2 class="fs-6"><a href="pages/shop-single.php" class="text-inherit text-decoration-none">Golden
                    Pineapple</a></h2>
                <div class="d-flex justify-content-between align-items-center mt-3">
                  <div><span class="text-dark">$13</span> <span
                      class="text-decoration-line-through text-muted">$18</span>
